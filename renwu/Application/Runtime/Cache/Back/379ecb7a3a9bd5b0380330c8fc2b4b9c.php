...
<ul class="bread  clearfix">
    ...
    <li><a href="/Back/Role/index"><?php echo ($pos["a"]); ?></a></li>
</ul>
<!--角色列表页面-->
        <style>
...
<div class="panel">
  <form method="post" action="/Back/Role/del">
      ...
      <table class="table table-hover text-center">
        <tr><?php if(isset($is_admin)): ?><th  width="8%" style="text-align:left; padding-left:20px;"><input type="checkbox" id="checkall"/>全选</th><?php endif; ?>
          <th width="5%">角色ID</th>
          <th>角色名称</th>
          <th>角色描述</th>
          <th>权限</th>
