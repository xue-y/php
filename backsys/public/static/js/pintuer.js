$(function(){
	...
	$pintuercheck=function(element,type,value){
		...
		switch(type){
			...
			case "wordpass":return /^([\w\.\@\!\-\_]){6,10}$/i.test($pintu);break;
            case "db":return /^([A-Za-z]+[\w]?){2,10}$/i.test($pintu);break;
			case "dirurl":return /^([A-Za-z]+[\w]?){2,10}$/i.test($pintu);break;
			case "title":return /^[\s\S]{2,10}$/i.test($pintu);break;
			case "key":return /^[\s\S]{3,50}$/i.test($pintu);break;
            ...
            case "code":return /^[a-zA-Z\d]{5}$/.test($pintu);break;
