...
<html lang="zh-CN">
<head>
    <title>{$Think.lang.title}-{$Think.lang.tips_info_hints}</title>
...
<div class="error-container">
    <h1> {$Think.lang.title}-{$Think.lang.tips_info_hints} </h1>
    <div class="errorcon">
        <?php switch ($code) {?>
            <?php case 1:?>
    ...
    <h4 class="smaller">{$Think.lang.tips_page_auto} <a id="href" href="<?php echo($url);?>">{$Think.lang.tips_jump}</a> {$Think.lang.tips_waiting_time}： <b id="wait"><?php echo($wait);?></b></h4>
</div>
