$(function(){
	...
	$('textarea, input, select').blur(function(){
		...
		if(e.attr("data-validate")){
			...
			if($checkstate){
				...
				e.closest('.field').append('<div class="input-help"><p>'+$checktext+'</p></div>');
			}
		}
	});
	$pintuercheck=function(element,type,value){
		...
		switch(type){
            case "host":return /^([\w\.]){9,20}$/i.test($pintu);break;
			case "wordpass":return /^[\w\.\@\!\-\_]{5,20}$/i.test($pintu);break;
            case "db":return /^([A-Za-z]+[\w]?){2,10}$/i.test($pintu);break;
			case "dirurl":return /^([A-Za-z]+[\w]?){2,10}$/i.test($pintu);break;
			case "title":return /^[\s\S]{1,10}$/i.test($pintu);break;
			case "key":return /^[\s\S]{3,60}$/.test($pintu);break;
			case "descipt":return /^[\s\S]{5,100}$/i.test($pintu);break;
			case "required":return /[^(^\s*)|(\s*$)]/.test($pintu);break;
			case "chinese":return /^[\u0391-\uFFE5]+$/.test($pintu);break;
			case "number":return /^\d{1,3}$/.test($pintu);break;
			case "integer":return /^[-\+]?\d+$/.test($pintu);break;
			case "plusinteger":return /^[+]?\d+$/.test($pintu);break;
			case "double":return /^[-\+]?\d+(\.\d+)?$/.test($pintu);break;
			case "plusdouble":return /^[+]?\d+(\.\d+)?$/.test($pintu);break;
			case "english":return /^[A-Za-z]+$/.test($pintu);break;
			case "username":return /^[a-z]\w{3,20}$/i.test($pintu);break;
            case "userp":return /^[\w\.\@\!\-\_]{6,12}$/i.test($pintu);break;
			case "mobile":return /^1(\d){10}$/.test($pintu);break;
			...
			case "num":return /^\d{5}$/.test($pintu);break;
            case "code":return /^\w{5}$/.test($pintu);break;
	//		case "dirfile":return /^([\/\\]?[a-zA-Z]+[\w]?[\/\\]?[\w]{3,25})[\.][a-zA-Z]{3,25}$/.test($pintu);break;
            case "dirfile":return /^([\/\\]?[\w]{3,25})[\.][a-zA-Z]{3,25}$/.test($pintu);break;
			case "radio":
