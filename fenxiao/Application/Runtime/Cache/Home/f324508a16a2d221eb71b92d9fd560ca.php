...
<h3>
    我的主页--<?php echo ($info["n"]); ?> <a class="float-right" href="/wx/Home/Set/index">设置</a> <!--后期改为设置-->
</h3>
    <h2>
        <img src="/wx/Public/back/images/user.png" width="70">
        <div  style="font-size:18px;">
        佣金金额：
        <?php if(($info["money"]) < "1"): ?>暂无佣金
            <p><a href="/wx/Home/Line/add">推荐好友赚佣金</a></p>
            <?php else: ?>
            <?php echo ($info["money"]); endif; ?>
        </div>
   </h2>
    <p  class="text-center">佣金提现说明：<a href="/wx/Home/Zx/index">请联系您的咨询师</a></p>
    <ul class="padding">

        <li><a href="/wx/Home/Set/cusBase"><span class="icon-cog"></span> 基本信息</a></li>
        <li><a href="/wx/Home/Line/index"><span  class="icon-star"></span> 我的推荐</a></li>
        <li><a href="/wx/Home/Info/index?status=1"><span  class=" icon-bell"></span>
            我的消息<?php if(($meg) >= "1"): ?><sup><?php echo ($meg); ?></sup><?php endif; ?>
            </a></li>
        <li><a href="/wx/Home/Set/index"><span class="icon-cogs"></span> 我的设置</a></li>
        <li><a href="/wx/Home/Zx/index"><span class="icon-user"></span> 我的客服</a></li>
    </ul>
