...
<ul class="bread  clearfix">
    ...
    <li><a href="/wx/Back/Role/index" id="a_leader_txt"><?php echo ($pos["c"]); ?></a></li>
    <li><a href="/wx/Back/Role/index"><?php echo ($pos["a"]); ?></a></li>
</ul>
...
<div class="panel">
  <form method="post" action="/wx/Back/Role/del">
      <div class="padding">
          <?php if(isset($is_admin)): ?><a class="button border-blue" href="/wx/Back/Role/add"><span class="icon-plus-square-o"></span><?php echo ($action_name["add"]); ?>角色</a>
      ...
      <table class="table table-hover text-center">
       ...
       <tbody>
         <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
          ...
          <td><a href="/wx/Back/Limit/index?id=<?php echo ($v["id"]); ?>">查看权限</a> </td>
          <td>
          <div class="button-group">
              <?php if($is_admin == 1): ?><!--如果登录用户是超级管理员-->
                  <a class="icon-edit" href="/wx/Back/Role/update?id=<?php echo ($v["id"]); ?>"> <?php echo ($action_name["update"]); ?></a><!--自己所属的角色-->
                  <?php if(($r_id) != $v["id"]): ?><a class="icon-trash-o" href="/wx/Back/Role/del?id=<?php echo ($v["id"]); ?>" onclick="return confirm('您确定要删除吗?')"> <?php echo ($action_name["del"]); ?></a><?php endif; ?><!--其他用户-->
                  <?php else: ?>
                  <?php if(($r_id) == $v["id"]): ?><a class="icon-edit" href="/wx/Back/Role/update?id=<?php echo ($v["id"]); ?>"> <?php echo ($action_name["update"]); ?></a><!--自己所属的角色--><?php endif; endif; ?>
          </div>
          </td>
