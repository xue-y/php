...
<head>
    ...
    <style type="text/css">
        *{ margin:0px; padding:0px;}
        ...
        .errorcon{ padding:20px 15px; text-align:center; color:#0ae; font-size:16px;}
...
<div class="error-container">
    ...
    <div class="errorcon">
        ...
        {
            $h='<p><i class="icon-smile-o"></i></p>';
            $h.=isset($data["info"])?$data["info"].'成功':'操作成功';
        }
        else
        {
            $h='<p><i class="icon-frown-o"></i></p>';
            $h.=isset($data["info"])?$data["info"].'失败':'操作失败!';
        }
             echo $h;
        ;?>
    </div>
    <h4 class="smaller">页面自动 <a id="href" href="<?php echo $data["url"]; ?>">跳转</a> 等待时间： <b id="wait"><?php echo $data["t"]; ?></b></h4>
</div>
