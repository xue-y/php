        ...
        <form method="post" class="form-x" action="/Php/Controll/<?php echo $all_data["p_url"];?>">
            ...
            <?php
               ...
               echo ' <div class="form-group">
                ...
                <div class="field">
                    <input type="number" class="input w50" name="'.$k.'" size="50" placeholder="请输入'.$v.'" data-validate="currency:请输入'.$v.'" />
                </div>
            </div>';
                }
              ?>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="date" class="input w50" name="t" size="50" />
                </div>
            </div>
            <div class="form-group">
                <div class="label">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea name="bz"  class="input" style="height:100px;" ></textarea>
