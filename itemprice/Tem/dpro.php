...
<div class="panel">
    ...
    <div class="padding">
        <a href="javascript:;" class="button border-blue" ><span class="icon-reply"></span>
            <input  value="批量还原" class="a_reply" name="edits" type="button"  onclick="DelSelect($(this),'还原','<?php echo $this->id_field ;?>')">
        </a>
            ...
            else
            {
                foreach($list as $v)
                {
                   echo '<tr>
                    ...
                    <td>
                        <a type="button" class="button border-blue" href="?h=edit&<?php echo $this->id_field.'='.$v["id"]; ?>"><span class="icon-reply"></span>  还原</a>
