    ...
    <form  method="post">
        <div class="padding">
            ...
            <a href="javascript:;" class="button border-red" ><span class="icon-trash-o"></span>
                <input  value="批量删除" class="a_del" name="dels" type="button"  onclick="DelSelect($(this),'删除','id')"></a>
        </div>
            ...
            <tr>
                ...
                <?php
                    ...
                    else
                    {
                        ...
                        <a class="button border-blue" href="'.PHP_CON.$this->c_file.'.php?h=add&'.$this->g_id_field.'='.$v["id"].'"><span class="icon-plus-square-o"></span>添加'.$this->c_name_c.'</a>
                        <a class="button border-yellow" href="?h=edit&id='.$v["id"].'"><span class="icon-edit"></span>修改</a>
                        <a class="button border-red" href="?h=del&id='.$v["id"].'" onclick="del($(this),\'删除\')"><span class="icon-trash-o"></span> 删除</a>
                         </div></td></tr>';
                        }
                    }
                /* 点击组名进入用户列表页面  --此组的所有用户 ($v["id"]-1)
                 * */
                ?>
